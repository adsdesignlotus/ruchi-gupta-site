...
import { useImagePreviewOptional } from "@/components/ImagePreviewProvider";
import { getCloudinaryCloudName } from "@/lib/cloudinary";
import type { PastEventDetail } from "@/lib/past-events";

/**
 * Expects a parent `ImagePreviewProvider` (e.g. `EventPageClient`) so we avoid a
 * nested provider + render-prop tree that can break island hydration.
 */
        ...
        <section aria-labelledby="invites-heading">
          <header className="mb-8 md:mb-10">
            ...
            <p className="mt-5 max-w-reading text-left text-base leading-prose text-text-secondary md:mt-6 md:text-lg">
              Tap an invite to view it full screen. PDFs download without leaving
